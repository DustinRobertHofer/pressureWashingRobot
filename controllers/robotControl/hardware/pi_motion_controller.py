from hardware.pi_motor import PiMotor
from hardware.pi_config import MOTION_PARAMS, ROBOT_PARAMS
...
class PiMotionController:
    ...
    def __init__(self):
        ...
        # Initialize motors
        self.left_motor = PiMotor('left_motor')
        self.right_motor = PiMotor('right_motor')
